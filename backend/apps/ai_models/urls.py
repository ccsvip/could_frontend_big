...
from .views import (
    ...
    CompanyTTSVoiceTestTextView,
    CompanyTTSTestView,
    CosyVoiceDesignView,
    CosyVoiceEnrollView,
    CosyVoiceSettingsView,
    CosyVoiceTestView,
    CosyVoiceVoiceDetailView,
    ...
    TenantTTSCardAuthorizationView,
...
urlpatterns = [
    ...
    path('settings/tts/cosyvoice/', CosyVoiceSettingsView.as_view(), name='cosyvoice-settings'),
    path('settings/tts/cosyvoice/test/', CosyVoiceTestView.as_view(), name='cosyvoice-test'),
    path('settings/tts/cosyvoice/voices/enroll/', CosyVoiceEnrollView.as_view(), name='cosyvoice-enroll'),
    path('settings/tts/cosyvoice/voices/design/', CosyVoiceDesignView.as_view(), name='cosyvoice-design'),
    path('settings/tts/cosyvoice/voices/<int:voice_id>/', CosyVoiceVoiceDetailView.as_view(), name='cosyvoice-voice-detail'),
    path('settings/tts/providers/', TTSProviderListView.as_view(), name='tts-provider-list'),
    path('settings/tts/tenants/<int:tenant_id>/card-authorizations/', TenantTTSCardAuthorizationView.as_view(), name='platform-tts-tenant-card-authorization'),
    ...
    path('ai-models/tts/voice-test-texts/<int:voice_id>/', CompanyTTSVoiceTestTextView.as_view(), name='company-tts-voice-test-text'),
