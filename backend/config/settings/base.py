...
APP_UPDATE_PACKAGE_NAME = os.getenv('APP_UPDATE_PACKAGE_NAME', 'com.lingzhi.digital')
APP_UPDATE_PRIVATE_KEY_BASE64 = os.getenv('APP_UPDATE_PRIVATE_KEcom.lingzhi.digital
...
CELERY_BEAT_SCHEDULER = 'config.celery_scheduler:ResilientDatabaseScheduler'
