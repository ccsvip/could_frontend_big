---
name: knowledge-base
description: "Skill for the Knowledge_base area of could_frontend_big. 82 symbols across 12 files."
---

# Knowledge_base

82 symbols | 12 files | Cohesion: 80%
...
| `backend/apps/knowledge_base/media_indexing.py` | _setting, _dashscope_api_key, _headers, _resource_public_url, _first_embedding (+4) |
...
| `backend/apps/accounts/services/notifications.py` | notify_account_application_reviewed |
| `backend/apps/accounts/views.py` | patch |
...
| `enqueue_media_asset_index` | Function | `backend/apps/knowledge_base/views.py` | 130 |
| `notify_account_application_reviewed` | Function | `backend/apps/accounts/services/notifications.py` | 26 |
| `notify_knowledge_document_event` | Function | `backend/apps/knowledge_base/services.py` | 17 |
| `notify_knowledge_document_deleted` | Function | `backend/apps/knowledge_base/services.py` | 33 |
| `notify_knowledge_bulk_download` | Function | `backend/apps/knowledge_base/services.py` | 49 |
