...
This project is indexed by GitNexus as **could_frontend_big** (9458 symbols, 18379 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
