...
This project is indexed by GitNexus as **could_frontend_big** (38509 symbols, 87545 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
