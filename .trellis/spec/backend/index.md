...
| [TTS Tenant Card Authorization](./tts-tenant-card-authorization.md) | Company TTS card grants, provider adapters, unified realtime prewarm/single-task streaming, frozen Android contract | Filled |
